...
public class FireStationController {
    ...
    @GetMapping
    public ResponseEntity<PersonsCoveredByFirestation> getPersonCoveredByFirestation(@RequestParam int stationNumber) throws InvalidAttributeValueException {
        ...
        return new ResponseEntity<PersonsCoveredByFirestation>(personCoveredByFirestation, HttpStatusCode.valueOf(200));
    }
